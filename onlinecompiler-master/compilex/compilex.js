...
exports.compileCPPWithInput = function ( envData , code , input ,file ,  fn ) { 
	if(exports.stats)
		cppModule.stats = true;
	cppModule.compileCPPWithInput(envData , code , input ,file, fn );	
}
...
exports.compileJavaWithInput = function ( envData , code , input ,file,  fn ){
	if(exports.stats)
		javaModule.stats = true;
	javaModule.compileJavaWithInput( envData , code , input ,file,  fn );	
}
...
exports.compilePythonWithInput = function( envData , code , input,file ,  fn){
	if(exports.stats)
		pyModule.stats = true;
	pyModule.compilePythonWithInput(envData , code , input ,file, fn );

}
exports.compilePerlWithInput = function( envData , code , input,file ,  fn){
	if(exports.stats)
		perlModule.stats = true;
	console.log("ente")
	perlModule.compilePerlWithInput(envData , code , input ,file, fn );
...
exports.compileRubyWithInput = function( envData , code , input,file ,  fn){
	...
	console.log("ente")
	rubyModule.compileRubyWithInput(envData , code , input ,file, fn );
...
exports.compileCSWithInput = function ( envData , code , input ,file,  fn ) { 
	if(exports.stats)
		csModule.stats = true;
	csModule.compileCSWithInput(envData , code , input,file , fn );	
}
...
exports.compileVBWithInput = function ( envData , code , input ,file,  fn ) { 
	if(exports.stats)
		vbModule.stats = true;
	vbModule.compileVBWithInput(envData , code , input,file , fn );	
}

exports.compilePhpWithInput = function ( envData , code , input ,file,  fn ) { 
	if(exports.stats)
		vbModule.stats = true;
	phpModule.compilePhpWithInput(envData , code , input ,file, fn );	
}
